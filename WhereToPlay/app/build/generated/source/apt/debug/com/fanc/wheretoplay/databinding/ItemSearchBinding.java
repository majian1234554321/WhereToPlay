...
public class ItemSearchBinding extends android.databinding.ViewDataBinding  {
    ...
    @NonNull
    public final android.widget.TextView tvItemSearch;
    // variables
    @Nullable
    private java.lang.String mSearch;
    // values
    // listeners
    ...
    public ItemSearchBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.tvItemSearch = (android.widget.TextView) bindings[1];
        this.tvItemSearch.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.search == variableId) {
            setSearch((java.lang.String) variable);
        }
        else {
            variableSet = false;
        }
    ...
    protected void executeBindings() {
        ...
        java.lang.String search = mSearch;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.tvItemSearch, search);
        }
    }
    ...
    public static ItemSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemSearchBinding>inflate(inflater, com.fanc.wheretoplay.R.layout.item_search, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemSearchBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.fanc.wheretoplay.R.layout.item_search, null, false), bindingComponent);
    }
    @NonNull
