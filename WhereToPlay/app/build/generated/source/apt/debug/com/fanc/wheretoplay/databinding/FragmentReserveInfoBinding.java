...
public class FragmentReserveInfoBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_reserve_info_name, 18);
        sViewsWithIds.put(R.id.et_reserve_info_name, 19);
        sViewsWithIds.put(R.id.view2, 20);
        sViewsWithIds.put(R.id.tv_reserve_info_mobile, 21);
        sViewsWithIds.put(R.id.et_reserve_info_mobile, 22);
        sViewsWithIds.put(R.id.tv_reserve_info_room_category, 23);
        sViewsWithIds.put(R.id.tv_reserve_info_reserve_time, 24);
        sViewsWithIds.put(R.id.tv_reserve_info_carport, 25);
        sViewsWithIds.put(R.id.et_reserve_info_carport, 26);
        sViewsWithIds.put(R.id.tv_reserve_info_number_of_people, 27);
        sViewsWithIds.put(R.id.et_reserve_info_number_of_people, 28);
        sViewsWithIds.put(R.id.tv_reserve_info_remark, 29);
        sViewsWithIds.put(R.id.et_reserve_info_remark, 30);
    }
    // views
    @NonNull
    ...
    public FragmentReserveInfoBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.etReserveInfoCarport = (android.widget.EditText) bindings[26];
        this.etReserveInfoMobile = (android.widget.EditText) bindings[22];
        this.etReserveInfoName = (android.widget.EditText) bindings[19];
        this.etReserveInfoNumberOfPeople = (android.widget.EditText) bindings[28];
        this.etReserveInfoRemark = (android.widget.EditText) bindings[30];
        ...
        this.tvReserveInfoCarport = (android.widget.TextView) bindings[25];
        ...
        this.tvReserveInfoMobile = (android.widget.TextView) bindings[21];
        this.tvReserveInfoName = (android.widget.TextView) bindings[18];
        this.tvReserveInfoNumberOfPeople = (android.widget.TextView) bindings[27];
        this.tvReserveInfoRemark = (android.widget.TextView) bindings[29];
        this.tvReserveInfoReserveTime = (android.widget.TextView) bindings[24];
        this.tvReserveInfoRoom = (android.widget.TextView) bindings[4];
        this.tvReserveInfoRoom.setTag(null);
        this.tvReserveInfoRoomCategory = (android.widget.TextView) bindings[23];
        ...
        this.view2 = (android.view.View) bindings[20];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            com.fanc.wheretoplay.datamodel.WaiterList.WaiterInfo.setWaiterImage(this.ivReserveInfo, storeCover);
