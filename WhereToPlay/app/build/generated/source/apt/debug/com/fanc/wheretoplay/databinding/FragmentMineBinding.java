...
public class FragmentMineBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tm_mine, 12);
        sViewsWithIds.put(R.id.civ_mine, 13);
        sViewsWithIds.put(R.id.tv_mine_nickname, 14);
        sViewsWithIds.put(R.id.tv_mine_mobile, 15);
        sViewsWithIds.put(R.id.tv_mine_integral, 16);
        sViewsWithIds.put(R.id.tv_mine_integral_1, 17);
    }
    // views
    @NonNull
    ...
    @NonNull
    public final com.fanc.wheretoplay.view.ItemView ivMineCommendFriend;
    @NonNull
    public final com.fanc.wheretoplay.view.ItemView ivMineCommendMoney;
    @NonNull
    ...
    public FragmentMineBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.civMine = (com.fanc.wheretoplay.view.CircleImageView) bindings[13];
        this.ivMineCollection = (com.fanc.wheretoplay.view.ItemView) bindings[7];
        this.ivMineCollection.setTag(null);
        this.ivMineCommendFriend = (com.fanc.wheretoplay.view.ItemView) bindings[8];
        this.ivMineCommendFriend.setTag(null);
        this.ivMineCommendMoney = (com.fanc.wheretoplay.view.ItemView) bindings[9];
        this.ivMineCommendMoney.setTag(null);
        this.ivMineDiscountCoupon = (com.fanc.wheretoplay.view.ItemView) bindings[4];
        this.ivMineDiscountCoupon.setTag(null);
        this.ivMineDrive = (com.fanc.wheretoplay.view.ItemView) bindings[11];
        ...
        this.ivMineReferral = (com.fanc.wheretoplay.view.ItemView) bindings[10];
        ...
        this.tmMine = (com.fanc.wheretoplay.view.TopMenu) bindings[12];
        this.tvMineIntegral = (android.widget.TextView) bindings[16];
        this.tvMineIntegral1 = (android.widget.TextView) bindings[17];
        this.tvMineMobile = (android.widget.TextView) bindings[15];
        this.tvMineNickname = (android.widget.TextView) bindings[14];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            this.ivMineCommendFriend.setOnClickListener(clickOnViewClickAndroidViewViewOnClickListener);
            this.ivMineCommendMoney.setOnClickListener(clickOnViewClickAndroidViewViewOnClickListener);
