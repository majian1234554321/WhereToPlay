...
public class OrderList2Fragment_ViewBinding implements Unbinder {
  private OrderList2Fragment target;

  @UiThread
  public OrderList2Fragment_ViewBinding(OrderList2Fragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    OrderList2Fragment target = this.target;
