...
public class FragmentPayBinding extends android.databinding.ViewDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tm_pay, 2);
        sViewsWithIds.put(R.id.rv_pay, 3);
    }
    // views
    @NonNull
    private final android.widget.LinearLayout mboundView0;
    @NonNull
    public final com.fanc.wheretoplay.view.PullToRefreshLayout ptrlPayReserve;
    @NonNull
    public final com.fanc.wheretoplay.view.PullableRecyclerView rvPay;
    @NonNull
    public final com.fanc.wheretoplay.view.TopMenu tmPay;
    // variables
    // values
    // listeners
    ...
    public FragmentPayBinding(@NonNull android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        ...
        this.ptrlPayReserve = (com.fanc.wheretoplay.view.PullToRefreshLayout) bindings[1];
        this.ptrlPayReserve.setTag(null);
        this.rvPay = (com.fanc.wheretoplay.view.PullableRecyclerView) bindings[3];
        this.tmPay = (com.fanc.wheretoplay.view.TopMenu) bindings[2];
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public static FragmentPayBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<FragmentPayBinding>inflate(inflater, com.fanc.wheretoplay.R.layout.fragment_pay, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static FragmentPayBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.fanc.wheretoplay.R.layout.fragment_pay, null, false), bindingComponent);
    }
    @NonNull
