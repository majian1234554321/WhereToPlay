...
class DataBinderMapper  {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                ...
                case com.fanc.wheretoplay.R.layout.mine_commend_money:
                    return com.fanc.wheretoplay.databinding.MineCommendMoneyBinding.bind(view, bindingComponent);
                ...
                case com.fanc.wheretoplay.R.layout.fragment_mine_friend:
                    return com.fanc.wheretoplay.databinding.FragmentMineFriendBinding.bind(view, bindingComponent);
    ...
    int getLayoutId(String tag) {
        ...
        switch(code) {
            ...
            case 1140786182: {
                if(tag.equals("layout/mine_commend_friend_0")) {
                    return com.fanc.wheretoplay.R.layout.mine_commend_friend;
                }
                break;
            }
            case -1742622933: {
            ...
            case -1036395430: {
                if(tag.equals("layout/mine_commend_money_0")) {
                    return com.fanc.wheretoplay.R.layout.mine_commend_money;
                }
                break;
            }
            case 757636349: {
            ...
            case 1084080657: {
                if(tag.equals("layout/fragment_mine_friend_0")) {
                    return com.fanc.wheretoplay.R.layout.fragment_mine_friend;
                }
                break;
            }
            case 2081945300: {
