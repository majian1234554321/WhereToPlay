...
public class AlterCityActivity extends BaseActivity {
  ...
  String[] hotCityStrings =
      new String[] {"北京", "上海", "广州", "深圳", "杭州", "南京", "温州", "宁波", "重庆", "厦门"};
  ...
  private void setListeners() {
    mTmAlterCity.setLeftIconOnClickListener(
    ...
    mSlbAlterCity.setOnLetterChangedListener(
    ...
    mLvAlterCityResult.setOnItemClickListener(
    ...
    public void handleMessage(Message msg) {
      switch (msg.what) {
        ...
        case 1:
          ...
          mCityAdapter.setOnCityClickListener(
              new CityAdapter.OnCityClickListener() {
                @Override
