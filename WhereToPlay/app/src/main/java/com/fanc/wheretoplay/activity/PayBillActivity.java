              ...
              new Observer<OrderDoneModel>() {
                ...
                public void onNext(OrderDoneModel orderDoneModel) {
                  if ("0".equals(orderDoneModel.code)
                    ...
                    mCbNotParticipation.setText("输入不参与优惠金额 服务费率" + cashRate + "%");
          ...
          public void onTextChanged(CharSequence s, int start, int before, int count) {
            if (s.toString().isEmpty()) {
              if (!TextUtils.isEmpty(mEtConsumeSum.getText().toString())) {
                ...
                String value =
                    df.format(
                        Double.parseDouble(mEtConsumeSum.getText().toString()) * discount / 10);
            ...
            //                // 计算优惠金额
            //                mTvDiscountSum.setText(String.valueOf((new BigDecimal(sum * (10 -
        ...
        new TextWatcher() {
          ...
          public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            if (lastPaySum < 0) {
              ...
              String value =
                  df.format(lastPaySum + Double.parseDouble(s.toString()) * (1 + cashRate / 100));
              mTvPaySumReal.setText(value);
            }
          }
            ...
            new Observer<AccessOrderIdModel>() {
              ...
              public void onNext(AccessOrderIdModel accessOrderIdModel) {
                ...
                if ("0".equals(accessOrderIdModel.code)) {
                  // Toast.makeText(PayBillActivity.this, accessOrderIdModel.content.order_id,
  ...
  class Receiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (Constants.ACTION_CHOOSE_DISCOUNT_COUPON.equals(action)) {
        ...
        //                // 计算优惠金额
        //                mTvDiscountSum.setText(String.valueOf(Math.abs((new BigDecimal(sum * (10 -
        // discount) / 10).add(new BigDecimal(discountPrice))).doubleValue())));
