        ...
        extends TextView
{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int        customPadding  = resources.getDimensionPixelSize(R.dimen.three_grid_unit_custom);

        //setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setGravity(Gravity.CENTER);
        setPadding(customPadding, defaultPadding, customPadding, defaultPadding);
        setClickable(true);
        setSingleLine(true);
...
//        setBackgroundResource(R.drawable.selector);
    ...
    private void setAdapterInternal(@NonNull NiceSpinnerBaseAdapter adapter) {
        ...
        setText(adapter.getItemInDataset(0)
                .toString());
    }
    ...
    private void animateArrow(boolean shouldRotateUp) {
        int            start    = shouldRotateUp
                                  ? 0
                                  : MAX_LEVEL;
        int            end      = shouldRotateUp
                                  ? MAX_LEVEL
                                  : 0;
