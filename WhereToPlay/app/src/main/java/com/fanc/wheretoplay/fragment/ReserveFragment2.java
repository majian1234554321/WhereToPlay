 ...
 * @date 2017/6/12
 */
public class ReserveFragment2 extends BaseFragment
    implements IOnFocusListener,
        LocationUtils.Callback,
  ...
  public View onCreateView(
    ...
    view.findViewById(R.id.ib_scan)
        .setOnClickListener(
              ...
              public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.CAMERA)
                  ...
                  ActivityCompat.requestPermissions(
                      mContext, new String[] {Manifest.permission.CAMERA}, 10085);
                } else {
  ...
  public void onRequestPermissionsResult(
    ...
    if (PermissionChecker.checkSelfPermission(mContext, Manifest.permission.CAMERA)
        == PackageManager.PERMISSION_GRANTED) {
      Intent intent = new Intent(mContext, CaptureActivity.class);
      startActivityForResult(intent, 10086);
    }
        ...
        if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
          ...
          if (result != null
            ...
            startActivity(intent);
              ...
              && result.contains("51tzl.cn/storedetail/")
              && result.split("51tzl.cn/storedetail/").length == 2) {
            String value = result.split("51tzl.cn/storedetail/")[1];
            Intent intent2 = new Intent(mContext, DetailActivity.class);
            intent2.putExtra(Constants.PAGE, Constants.MERCHANT_DETAIL);
            intent2.putExtra(Constants.STORE_ID, value);
            intent2.putExtra("type", type);

            ActivityOptionsCompat compat =
                ActivityOptionsCompat.makeCustomAnimation(
                    mContext, R.anim.anim_enter_bottom, R.anim.anim_out_top_right);
            ActivityCompat.startActivity(mContext, intent2, compat.toBundle());
          } else {
  ...
  private void init() {
    ...
    showProgress();
    getFilterList(
        null, Double.parseDouble(DataValue.latitude), Double.parseDouble(DataValue.longitude));
  ...
  private void setListener() {
    ...
    onTouchListener =
        new MainActivity.MyOnTouchListener() {
    ...
    /*去掉首页选择栏按钮*/
    mLlReserveArea.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
    ...
    mLlReserveFilterReal.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
    ...
    mLlReserveAreaSuspend.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
    ...
    mLlReserveFilterRealSuspend.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
  ...
  private void newPopupWindow() {
    ...
    filterArea =
        new FilterPopupDialog(mContext).setPopupWindowHeight(254).setAdapter(filterAreaAdapter);

    // 筛选（两级菜单）
    filterAdapter = new FilterPopDialogAdapter(mContext, filterBeans);
    filter = new FilterPopupDialog(mContext).setAdapter(filterAdapter);
  }

  private void setPopupWindowClickListener() {
    filterAreaAdapter.setListener(
        new FilterPopDialogAdapter.OnItemClickListener() {
          @Override
          public void onItemClick(String name, String dataID, int position) {
            ...
            showProgress();
            getStoreList(
                "onRefresh", city.getId(), 0, 0, areaId, storeType, category, filterType, value);
          }
        });

    // 店家   房型，装修风格，档次，活动和优惠等
    filterAdapter.setListener(
        new FilterPopDialogAdapter.OnItemClickListener() {
          @Override
          public void onItemClick(String name, String dataID, int position) {
            if (position == 0) {
  ...
  private void setPopupWindowDismissListener() {
    filterArea.setOnDismissListener(
   ...
   * @param isRotated
   */
  private void setImageViewRotateAnimation(
      ImageView imageView1, ImageView imageView2, boolean isRotated) {
    if (isRotated) {
  ...
  private void setImageViewRotateAnimationUnrotate(final ImageView imageView) {
    ...
    animation_up.setAnimationListener(
  ...
  private RotateAnimation trilateral_0_180_Animation() {
    ...
    if (animation_up == null) {
      animation_up =
          (RotateAnimation) AnimationUtils.loadAnimation(mContext, R.anim.rotate_down_deal_filter);
    }
  ...
  private RotateAnimation trilateral_180_360_Animation() {
    ...
    RotateAnimation animation_down =
        (RotateAnimation) AnimationUtils.loadAnimation(mContext, R.anim.rotate_up_deal_filter);
  ...
  public void onRefresh() {
    ...
    size = count;
    getStoreList(
        "onRefresh", city.getId(), page, size, areaId, storeType, category, filterType, value);
  }
  ...
  public void onLoadMore() {
    ...
    page++;
    getStoreList(
        "onLoadMore", city.getId(), page, size, areaId, storeType, category, filterType, value);
  }
  ...
  class Receiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      page = 0;
      getStoreList(
          "onRefresh", city.getId(), 0, 10, areaId, storeType, category, filterType, value);
    }
  }
  ...
  public void setStoreType(String storeType) {
    ...
    page = 0;
    getStoreList(
        "onRefresh", city.getId(), 0, count, areaId, this.storeType, category, filterType, value);
  }
